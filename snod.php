...
<div id="section1"> 
  <div class="head"> Welcome to Delete Member by Roll No PHP Page</div>
	<br><?php
	$con=mysqli_connect("localhost","root","","bcc");

	$sql="DELETE FROM registration WHERE  sno='$_POST[snod]'";  
   if (mysqli_query($con,$sql))
  {
  echo "Data Deleted from table registration successfully";
  }
  else
  {
  echo "Error deleting data from registration table: " . mysqli_error($con);
  }    
mysqli_close($con);
?>
</div>
